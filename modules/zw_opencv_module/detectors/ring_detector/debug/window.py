...
class RingDebugWindow(BaseDebugWindow):
    _STAGE_NAMES = ["Auto", "Global", "Alt Hough", "Color Blob", "Fallback"]
    _METHOD_NAMES = ["FAST_RING", "EDGE_DRAWING_RING", "HEURISTIC_RING"]
    _PREVIEW_LABELS = {
        0: "Original",
        1: "Edge Preview",
        2: "Color Mask",
    ...
    def update(self, frame=None, result=None,
               intermediates=None, ring_data=None):
    ...
    def _build_circle_preview(self) -> np.ndarray:
        ...
        for meta in self._ring_data.values():
